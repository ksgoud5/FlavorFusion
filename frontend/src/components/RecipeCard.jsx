...
const RecipeCard = ({ recipe }) => {
  ...
  return (
    <Link
      ...
      className="group bg-white dark:bg-gray-800 rounded-2xl shadow-sm hover:shadow-xl dark:shadow-none dark:border dark:border-gray-700 transition-shadow duration-300 overflow-hidden block"
    >
      <div className="relative overflow-hidden h-48">
        ...
        <span className="absolute top-3 right-3 bg-white/90 dark:bg-gray-900/80 backdrop-blur text-red-500 text-xs font-semibold px-2.5 py-1 rounded-full flex items-center gap-1">
